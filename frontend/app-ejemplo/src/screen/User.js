...
const User = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('http://192.168.200.6:9004/nombres')
    ...
    const deleteUser = async (item) => {
        try {
            const response = await fetch(`http://192.168.200.6:9004/nombres/${item.id}`, {
                method: 'DELETE'
            })
    ...
    const editUser = async () => {
        try {
            const response = await fetch(`http://192.168.200.6:9004/nombres/${selectedUser.id}`, {
                method: 'PUT',
                headers: {
